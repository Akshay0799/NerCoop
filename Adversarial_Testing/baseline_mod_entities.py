...
#Install skweak library to read the spacy file
...
def replace_entities(ent_dict, samples):
	wor = []
	ta = []
	for e in samples:
		words_temp = []
...
def main(args):
	...
	entity_dict = get_entities(samples)

	words, tags = replace_entities(entity_dict, samples)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file", help="Name or path of the input test file in spacy format", required=True)
